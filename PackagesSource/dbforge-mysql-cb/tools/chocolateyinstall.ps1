...
$url        = 'https://chocolatey.devart.com/files/3B7EE8BBD06C00FED4886CCBA36E80CFB6A6081F4F3F524B3B6E6187263FE3AE/comparebundlemysql.exe' 
$packageArgs = @{
  ...
  checksum      = '3B7EE8BBD06C00FED4886CCBA36E80CFB6A6081F4F3F524B3B6E6187263FE3AE'
  checksumType  = 'sha256' 
