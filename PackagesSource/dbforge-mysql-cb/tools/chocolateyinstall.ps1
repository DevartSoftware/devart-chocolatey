...
$url        = 'https://choco.devart.com/s/C926DAD3323133D6A1CB0C9CA22577F51293162188C984EF937BA615AE045C16/comparebundlemysql.exe' 
$packageArgs = @{
  ...
  checksum      = 'C926DAD3323133D6A1CB0C9CA22577F51293162188C984EF937BA615AE045C16'
  checksumType  = 'sha256' 
